...
public:
    ...
    /**
      * Populate (member variable) solution as a list of coordinates from start_coord to end_coord, represented as {q, r} pairs. Q: how? based on the generate record?
...
private:
    ...
    /**
     * Set all cells in this->cells to have the appropriate neighbours.   Q: meaning？
     */
